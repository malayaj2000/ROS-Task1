...
(cl:in-package tiburon_task_trainee-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <complexOperation-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'complexOperation-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tiburon_task_trainee-srv:<complexOperation-request> is deprecated: use tiburon_task_trainee-srv:complexOperation-request instead.")))

(cl:ensure-generic-function 'r1-val :lambda-list '(m))
(cl:defmethod r1-val ((m <complexOperation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:r1-val is deprecated.  Use tiburon_task_trainee-srv:r1 instead.")
  (r1 m))

(cl:ensure-generic-function 'r2-val :lambda-list '(m))
(cl:defmethod r2-val ((m <complexOperation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:r2-val is deprecated.  Use tiburon_task_trainee-srv:r2 instead.")
  (r2 m))

(cl:ensure-generic-function 'i1-val :lambda-list '(m))
(cl:defmethod i1-val ((m <complexOperation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:i1-val is deprecated.  Use tiburon_task_trainee-srv:i1 instead.")
  (i1 m))

(cl:ensure-generic-function 'i2-val :lambda-list '(m))
(cl:defmethod i2-val ((m <complexOperation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:i2-val is deprecated.  Use tiburon_task_trainee-srv:i2 instead.")
  (i2 m))

(cl:ensure-generic-function 'op-val :lambda-list '(m))
(cl:defmethod op-val ((m <complexOperation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:op-val is deprecated.  Use tiburon_task_trainee-srv:op instead.")
  (op m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<complexOperation-request>)))
  ...
  "tiburon_task_trainee/complexOperationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'complexOperation-request)))
  "Returns string type for a service object of type 'complexOperation-request"
  "tiburon_task_trainee/complexOperationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <complexOperation-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'complexOperation-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tiburon_task_trainee-srv:<complexOperation-response> is deprecated: use tiburon_task_trainee-srv:complexOperation-response instead.")))

(cl:ensure-generic-function 'r3-val :lambda-list '(m))
(cl:defmethod r3-val ((m <complexOperation-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:r3-val is deprecated.  Use tiburon_task_trainee-srv:r3 instead.")
  (r3 m))

(cl:ensure-generic-function 'i3-val :lambda-list '(m))
(cl:defmethod i3-val ((m <complexOperation-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiburon_task_trainee-srv:i3-val is deprecated.  Use tiburon_task_trainee-srv:i3 instead.")
  (i3 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<complexOperation-response>)))
  ...
  "tiburon_task_trainee/complexOperationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'complexOperation-response)))
  "Returns string type for a service object of type 'complexOperation-response"
  "tiburon_task_trainee/complexOperationResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'complexOperation)))
  ...
  "tiburon_task_trainee/complexOperation")